...
public class SwagggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Blogging Application : Backend API",
				"This project is developed by Upendra Rai", "1.0", "Terms of Service",
				new Contact("Upendra Rai", "https://upendra-rai.github.io/upendra-portfolio/", "upendrarai02@gmail.com"),
